    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Tambah Siswa</h4>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Inputkan data jumlah siswa.</h6>
                        @if (count($tahun_ajar) == 0)
                            <div class="alert alert-danger">Mohon konfirmasi operator korwil untuk mengisi tahun ajar.
                            </div>
                        @endif
                        <form id="form-proses-siswa" class="m-t-40" action="{{ URL::to('/siswa/proses') }}" method="GET"
                            novalidate>
        ...
        @if (Session::has('kelas'))
            @if (count(Session::get('kelas')) > 0)
                <form id="form-tambah-siswa" action="{{ URL::to('/siswa/save') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
