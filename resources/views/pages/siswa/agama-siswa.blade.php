    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Agama Siswa</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:vo">Agama Siswa</a></li>
                        <li class="breadcrumb-item
                                active">Agama Siswa</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Data master jumlah siswa berdasarkan agama.</h6>
                        <div class="table-responsive m-t-40">
                            <form id="form-proses-siswa" action="{{ URL::to('/siswa/agama/filter') }}" method="GET"
                                novalidate>
                                <div class="row">
