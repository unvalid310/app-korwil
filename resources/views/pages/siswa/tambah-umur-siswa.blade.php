                        ...
                        success: function(data) {
                            ...
                            if (data.success) {
                                ...
                                setTimeout(function() {
                                    ...
                                    window.location.href = "{{ URL::to('/siswa/umur') }}";
                                }, 1000);
                            } else {
                                preload.fadeOut();
                                $.toast({
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Tambah Umur Siswa</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Siswa</li>
                        <li class="breadcrumb-item active">Tambah Umur Siswa</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tambah Umur Siswa</h4>
                        <h6 class="card-subtitle">Inputkan data jumlah siswa berdasarkam umur.</h6>
                        @if (count($tahun_ajar) == 0)
                            <div class="alert alert-danger">Mohon konfirmasi operator korwil untuk mengisi tahun ajar.
                            </div>
                        @endif
                        <form id="form-proses-siswa" class="m-t-40" action="{{ URL::to('/siswa/proses-umur') }}"
        ...
        @if (Session::has('kelas'))
            @if (count(Session::get('kelas')) > 0)
                <form id="form-tambah-siswa" action="{{ URL::to('/siswa/save-umur') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
