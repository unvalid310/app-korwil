    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Update Kelas</h4>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Update data kelas.</h6>
                        ...
                        @endif
                        <form id="form-tambah-staff" class="m-t-40" action="{{ URL::to('/kelas/edit') }}" method="POST"
                            novalidate>
                            <div class="row">
                                        ...
                                        <div class="controls">
                                            <select class="select2 m-b-10 form-control" style="width: 100%"
                                                ...
                                                @foreach ($staff as $item)
                                                    @if ($item->id_staff == $kelas->id_staff)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" placeholder="Kelas" name="kelas"
                                                ...
                                                data-validation-required-message="Masukan nama kelas">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" placeholder="Alias" name="alias"
                                                value="{{ $kelas->alias }}" required
                                                data-validation-required-message="Masukan alias kelas">
