    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Tambah Staff</h4>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Inputkan data staff.</h6>
                        <form id="form-tambah-staff" class="m-t-40" action="{{ URL::to('/staff/save') }}" method="POST"
                            novalidate>
                            <div class="row">
